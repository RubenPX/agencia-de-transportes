                ...
                <div class="card border-primary col m-2">
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-2 pb-1">
                            ...
                            <div class="col-sm-6">
                                <input type="text" readonly class="form-control-plaintext" id="completed"
                                    value="3">
                            </div>
                        </div>
                        <div class="form-group row mb-2 pb-1">
                            ...
                            <div class="col-sm-6">
                                <input type="text" readonly class="form-control-plaintext" id="finished"
                                    value="5">
                            </div>
                        </div>

                        <button type="button" class="btn btn-info w-100 mt-2">Ver repartos</button>
                    </div>
                </div>
            </div>
        </div>
